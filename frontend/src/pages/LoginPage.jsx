...
const LoginPage = () => {
  ...
  return (
    <div className="h-screen grid lg:grid-cols-2">
      ...
      {/* Right Side - Visual */}
      <div className="hidden lg:flex items-center justify-center bg-white/02 p-12">
        <div className="max-w-md text-center space-y-6">
          <div className="grid grid-cols-3 gap-3 mb-8">
            {[...Array(9)].map((_, i) => (
              <div key={i} className={`aspect-square rounded-2xl glass-morphism ${i % 2 === 0 ? "animate-pulse" : ""}`}></div>
            ))}
          </div>
          <h2 className="text-4xl font-bold font-outfit">Welcome back!</h2>
