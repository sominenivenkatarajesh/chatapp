        ...
        <div className="login-section">
          ...
          <div className="text-center">
            <div className="flex flex-col items-center gap-4 group">
              <div
                className="size-14 rounded-2xl bg-amber-500/15 flex items-center justify-center 
              group-hover:bg-amber-500/25 transition-all duration-500 group-hover:rotate-6 group-hover:scale-105 border border-amber-500/30 shadow-lg shadow-amber-500/10"
              >
                <MessageSquare className="size-7 text-amber-400" />
              </div>
              <div className="space-y-1 mt-1">
                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-amber-500/90 block">Join Chatly</span>
                <h1 className="text-3xl font-extrabold tracking-tight text-white">Create Account</h1>
                <p className="text-zinc-400 text-sm">Join our real-time messaging workspace</p>
              </div>
            </div>
          </div>
